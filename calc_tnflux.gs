...
* psiaa
   'psia = psiaa'
*
   'set sdfwrite -flt erai_px_day_'year'.nc'
   'sdfwrite px'
   'set sdfwrite -flt erai_py_day_'year'.nc'
   'sdfwrite py'
   'set sdfwrite -flt erai_pz_day_'year'.nc'
   'sdfwrite pz'
   'set sdfwrite -flt erai_div_day_'year'.nc'
   'sdfwrite div'
   'set sdfwrite -flt erai_psiaa_day_'year'.nc'
   'sdfwrite psia'
 year = year+1
 say year
 'reinit'
